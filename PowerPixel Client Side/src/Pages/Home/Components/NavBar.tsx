  ...
  return (
    <div>
      <nav className="fixed top-0 left-0 right-0 z-50">
        <div className="bg-slate-900 shadow-md py-4 px-4 sm:px-6 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-7 sm:space-y-0">
          {/* Top row: Logo and Sign In */}
          <div className="flex justify-between items-center">
            <Link to="/">
              <h2 className="text-2xl font-extrabold bg-gradient-to-r from-cyan-400 to-blue-400 text-transparent bg-clip-text">
                PowerPixel
              </h2>

              <p className="text-xs font-bold text-nowrap text-cyan-300">
            ...
            >
              ...
              <div className="relative">
                ...
                <input
                  type="search"
                  id="default-search"
                  className="block w-full outline-none p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500 placeholder-gray-600 focus:ring-2"
